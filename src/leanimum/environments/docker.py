...
class DockerEnvironmentConfig(BaseModel):
    ...
    executable: str = os.getenv("LEANA_DOCKER_EXECUTABLE", "docker")
...
class DockerEnvironment:
    def __init__(
        ...
        **kwargs,
        ...
        """
        self.logger = logger or logging.getLogger("leanimum.environment")
    ...
    def _start_container(self):
        ...
        container_name = f"leanimum-{uuid.uuid4().hex[:8]}"
        cmd = [
