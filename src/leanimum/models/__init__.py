...
_MODEL_CLASS_MAPPING = {
    "litellm": "leanimum.models.litellm_model.LitellmModel",
    "litellm_textbased": "leanimum.models.litellm_textbased_model.LitellmTextbasedModel",
    "litellm_response": "leanimum.models.litellm_response_model.LitellmResponseModel",
    "openrouter": "leanimum.models.openrouter_model.OpenRouterModel",
    "openrouter_textbased": "leanimum.models.openrouter_textbased_model.OpenRouterTextbasedModel",
    "openrouter_response": "leanimum.models.openrouter_response_model.OpenRouterResponseModel",
    "portkey": "leanimum.models.portkey_model.PortkeyModel",
    "portkey_response": "leanimum.models.portkey_response_model.PortkeyResponseAPIModel",
    "requesty": "leanimum.models.requesty_model.RequestyModel",
    "deterministic": "leanimum.models.test_models.DeterministicModel",
}
...
def get_model_class(model_name: str, model_class: str = "") -> type:
    ...
    e.g., "anthropic" or "leanimum.models.anthropic.AnthropicModel"),
