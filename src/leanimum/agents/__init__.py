"""Agent implementations for Leanimum-agent."""

import copy
import importlib

from leanimum import Agent, Environment, Model

_AGENT_MAPPING = {
    "default": "leanimum.agents.default.DefaultAgent",
    "interactive": "leanimum.agents.interactive.InteractiveAgent",
}
