...
from leanimum import global_config_dir
from leanimum.agents import get_agent
from leanimum.agents.utils.prompt_user import _multiline_prompt
...
_HELP_TEXT = """Run Leanimum-agent in your local environment.

[not dim]
More information about the usage: [bold green]https://github.com/zeyu-zheng/Leanimum-agent#readme[/bold green]
[/not dim]
"""
