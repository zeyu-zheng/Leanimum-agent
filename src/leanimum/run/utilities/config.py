...
from leanimum import global_config_file
...
You can edit it manually or use the [bold green]leani-extra config set[/bold green] or [bold green]leani-extra config edit[/bold green] commands.
