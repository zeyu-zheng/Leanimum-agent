...
- If your component is a bit more specific, add it into an `extra` folder (like [this one](https://github.com/zeyu-zheng/Leanimum-agent/tree/main/src/leanimum/run/extra))
